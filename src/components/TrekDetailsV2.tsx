...
interface TrekProps {
    ...
    trek: {
        ...
        itinerary: { day: string; title: string; content: PortableTextBlock[]; imageUrl?: string; walkTime?: string; highlight?: string }[];
        ...
        <div className="bg-white">
            ...
            <section className="w-full border-b border-zinc-border bg-slate-50">
                <div className="max-w-[1440px] mx-auto grid grid-cols-2 md:grid-cols-4">
                    {[
                        { label: 'Difficulty', value: trek.difficulty, description: trek.difficultyDescription },
                        { label: 'Duration', value: trek.duration, description: trek.durationDescription },
                        { label: 'Altitude', value: trek.altitude, description: trek.altitudeDescription },
                    ].map((stat, index) => (
                        <div
                            key={stat.label}
                        ...
                        >
                            ...
                            {stat.description && (
                                <p className="text-xs md:text-sm text-slate-500 leading-tight">{stat.description}</p>
                            )}
                        </div>
                    ))}
                            ...
                            {trek.itineraryPdfUrl && (
                                <div className="shrink-0 border-2 border-primary bg-primary/5 p-5 flex items-center gap-5 md:max-w-[320px]">
                                    ...
                                    <a
                                        ...
                                        download
                                        onClick={() => trackCTA({ cta_name: 'download_itinerary', location: 'itinerary_section' })}
                                    ...
                                    return (
                                        <div className="border border-zinc-border bg-slate-900 text-white p-6">
                                            ...
                                            <a
                                                ...
                                                onClick={() => trackCTA({ cta_name: 'plan_private_custom_trek', location: 'no_departures_card', channel: 'whatsapp' })}
                                    ...
                                    <>
                                                ...
                                                <div key={index} className="bg-white border border-zinc-border p-5 flex flex-col gap-4">
                                                    <div className="flex justify-between items-start">
                                                        ...
                                                        <div className="text-right">
                                                            ...
                                                            <p className="text-xs font-bold">{batch.remaining} / {batch.totalSeats}</p>
                                                        </div>
                                                    </div>
                                                    {batch.trekLead && (
                                                    ...
                                                    <a
                                                        ...
                                                        target={whatsappNumber ? '_blank' : undefined}
                                                        rel={whatsappNumber ? 'noopener noreferrer' : undefined}
                                                        onClick={() => trackCTA({ cta_name: 'secure_spot', location: 'departure_section', channel: 'whatsapp', departure: batch.date })}
                                        ...
                                        <div className="mt-6 pt-5 border-t border-zinc-border">
                                            ...
                                            <a
                                                ...
                                                target={whatsappNumber ? '_blank' : undefined}
                                                rel={whatsappNumber ? 'noopener noreferrer' : undefined}
                                                onClick={() => trackCTA({ cta_name: 'message_trek_team', location: 'departure_section', channel: 'whatsapp' })}
                ...
                <div className="max-w-[1440px] mx-auto px-8 py-16 md:py-20 flex flex-col items-center text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <a
                            ...
                            target={whatsappNumber ? '_blank' : undefined}
                            rel={whatsappNumber ? 'noopener noreferrer' : undefined}
                            onClick={() => trackCTA({ cta_name: 'message_trek_team', location: 'trek_team_section', channel: 'whatsapp' })}
                        ...
                        <a
                            href="#enquire"
                            onClick={() => trackCTA({ cta_name: 'write_enquiry', location: 'trek_team_section' })}
            ...
            {trek.relatedTreks && trek.relatedTreks.length > 0 && (
                <section className="border-t border-zinc-border bg-slate-900 text-white">
                    <div className="max-w-[1440px] mx-auto p-8 md:p-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-12">Related Treks</h2>
