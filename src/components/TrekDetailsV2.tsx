                                            ...
                                            {upcomingBatches.map((batch, index) => (
                                                <div key={index} className="bg-white border border-zinc-border p-5 flex flex-col gap-4">
                                                    ...
                                                    <a
                                                        ...
                                                        target={whatsappNumber ? '_blank' : undefined}
                                                        rel={whatsappNumber ? 'noopener noreferrer' : undefined}
                                                        onClick={() => trackEvent(AnalyticsEvents.CTA_CLICK, { cta_name: 'secure_spot', location: 'departure_section', channel: 'whatsapp', departure: batch.date })}
                ...
                <div className="max-w-[1440px] mx-auto px-8 py-16 md:py-20 flex flex-col items-center text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <a
                            ...
                            target={whatsappNumber ? '_blank' : undefined}
                            rel={whatsappNumber ? 'noopener noreferrer' : undefined}
                            onClick={() => trackEvent(AnalyticsEvents.CTA_CLICK, { cta_name: 'message_trek_team', location: 'trek_team_section', channel: 'whatsapp' })}
