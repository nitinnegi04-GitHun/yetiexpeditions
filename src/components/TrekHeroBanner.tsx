    ...
    if (videoSrc) {
        return (
            <video
                ...
                loop
                playsInline
                className="absolute inset-0 w-full h-full object-cover grayscale-[55%] brightness-95 contrast-110 trek-hero-mobile-reveal group-hover:grayscale-0 transition-all duration-700"
            />
        );
    }
