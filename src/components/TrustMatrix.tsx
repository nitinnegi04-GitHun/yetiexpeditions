export default function TrustMatrix() {
    const items = [
        { label: "Guide Ratio", value: "1:4", description: "Industry leading safety supervision for every trekker." },
        { label: "Certification", value: "WFR", description: "Wilderness First Responder certified lead guides." },
        { label: "Group Limit", value: "MAX 8", description: "Small groups ensure personalized care and flexibility." },
        { label: "Experience", value: "15YR+", description: "Decades of navigating the world's most difficult terrain." },
    ];
