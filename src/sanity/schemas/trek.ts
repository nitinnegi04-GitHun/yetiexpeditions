...
export const trek = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'difficultyDescription', title: 'Difficulty Description', type: 'string', group: 'overview', description: 'Shown under the Difficulty stat on the trek page. e.g. "Steady daily ascents, no technical climbing."' }),
    ...
    defineField({ name: 'durationDescription', title: 'Duration Description', type: 'string', group: 'overview', description: 'Shown under the Duration stat on the trek page. e.g. "Including 2 acclimatisation days."' }),
    ...
    defineField({ name: 'altitudeDescription', title: 'Altitude Description', type: 'string', group: 'overview', description: 'Shown under the Altitude stat on the trek page. e.g. "Highest point of the trek."' }),
